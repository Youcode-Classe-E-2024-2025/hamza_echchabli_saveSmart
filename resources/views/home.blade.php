...
<body class="bg-gradient-to-r from-indigo-600 to-blue-500 text-white">
    ...
    <div class="min-h-screen flex flex-col justify-center items-center px-4">
        ...
        <section class="text-center py-20">
            ...
            <p class="text-2xl mb-6 max-w-3xl mx-auto">Your Ultimate Personal Finance Management Tool. Easily track, save, and grow your finances with a simple and intuitive platform.</p>
            ...
            <div class="max-w-5xl mx-auto text-center">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="p-6 bg-white rounded-lg shadow-lg">
                        <h3 class="text-xl font-semibold mb-4">Track Your Expenses</h3>
                    ...
                    <div class="p-6 bg-white rounded-lg shadow-lg">
                        <h3 class="text-xl font-semibold mb-4">Budgeting Made Easy</h3>
                        <p class="text-gray-700">Set budgets, track your progress, and get notified when you're nearing your budget limits.</p>
                    </div>
                    <div class="p-6 bg-white rounded-lg shadow-lg">
                        <h3 class="text-xl font-semibold mb-4">Multiple Accounts</h3>
